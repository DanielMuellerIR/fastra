...
ALL_TESTS=(windows newwindow findbar fields tabswitch highlight jump ghosttext replaceall pilldrop navmatch colsel gutterdim search project git gitactions filemodes selsearch wildcard openscope contrast cmdw)
# Fensterlose Tests — laufen auch bei gesperrtem Bildschirm aussagekräftig.
WINDOWLESS_TESTS=(search project git gitactions filemodes selsearch wildcard openscope)
