...
ALL_TESTS=(windows newwindow multisearch findbar fields tabswitch highlight jump ghosttext replaceall pilldrop navmatch colsel gutterdim search project localization git gitactions filemodes selsearch wildcard openscope contrast cmdw)
