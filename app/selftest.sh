...
ALL_TESTS=(windows newwindow findbar fields tabswitch highlight jump replaceall pilldrop navmatch search selsearch wildcard openscope contrast cmdw)
# Fensterlose Tests — laufen auch bei gesperrtem Bildschirm aussagekräftig.
WINDOWLESS_TESTS=(search selsearch wildcard openscope)
