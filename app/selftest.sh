...
ALL_TESTS=(windows newwindow findbar fields tabswitch highlight jump ghosttext replaceall pilldrop navmatch colsel gutterdim search project localization git gitactions filemodes selsearch wildcard openscope contrast cmdw)
