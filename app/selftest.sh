...
ALL_TESTS=(windows newwindow welcomenew multisearch findbar fields tabswitch tabcompare softwrapprofiles softwrapmodes softwrapanchor highlight highlight4d completion4d previewrender xpath markdown markdownjump markdownappearance jump ghosttext hscroll replaceall pilldrop navmatch joinundo colsel colselwrap colpaste gutterdim sidebarheader sidebarfilter filediff tool4dhint tool4dlsp gototarget searchmark help mdassist search project localization updates git gitactions filemodes selsearch wildcard openscope contrast cmdw)
